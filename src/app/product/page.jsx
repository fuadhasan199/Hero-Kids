...
<div className="dropdown dropdown-hover">
  <div tabIndex={0} role="button" className="btn m-2 bg-gradient-to-r from-orange-500 to-red-500 hover:from-orange-600 hover:to-red-600 mr-[80px]">Sort</div>
  <ul tabIndex="-1" className="dropdown-content menu bg-base-content rounded-box z-1  w-52 p-5 shadow-sm">
    <li><a>default</a></li>
